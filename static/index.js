...
var ROOT_ERROR = "Extension UI setup can not be complete. A root element that should be provided by a platform could not be found.";
...
function useMPTContext() {
  const [context, setContext] = (0, import_react.useState)(window.__MPT__.context);
  (0, import_react.useEffect)(() => {
    setContext(window.__MPT__.context);
    window.__MPT__.onChange((data) => {
      setContext(data);
    });
  }, []);
  return context;
...
function useMPTEmit() {
  return (0, import_react2.useCallback)((event, data) => window.__MPT__.emit(event, data), []);
}
function useMPTListen(event, handler, dependencies = []) {
  (0, import_react3.useEffect)(() => window.__MPT__.listen(event, handler), [event, ...dependencies]);
}
var REQUEST_MODAL_CLOSE_EVENT = "$close";
var REPORT_MODAL_CLOSE_EVENT = "$closed";
var REQUEST_MODAL_OPEN_EVENT = "$open";
var noop = (...args) => {
};
function useMPTModal() {
  const emit = useMPTEmit2();
  const closeCallback = (0, import_react4.useRef)(noop);
  const open = (0, import_react4.useCallback)((id, config) => {
    if (!id) return;
  ...
  const close = (0, import_react4.useCallback)((data) => {
...
var useMPTContext2 = useMPTContext;
var useMPTEmit2 = useMPTEmit;
...
var App_default = () => {
  ...
  const { open, close } = useMPTModal2();
  const openModal = (0, import_react5.useCallback)(() => {
    open("modal", {
      context: {
        ...data,
      ...
      onClose: (data2) => {
        console.log(`\u{1F4E2} Requested modal was closed with ${JSON.stringify(data2)}`);
      }
    });
  }, [open, data]);
  const closeModal = (0, import_react5.useCallback)((key) => {
    close(key);
  }, [close]);
  const contextAuthSnapshot = (0, import_react5.useMemo)(() => {
    if (!auth) return [];
    return Object.keys(auth).map((k) => [k, auth[k]?.id ?? JSON.stringify(auth[k])]);
  }, [data]);
  const contextDataSnapshot = (0, import_react5.useMemo)(() => {
    if (!data) return [];
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "container", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "A brave lil extension" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: contextAuthSnapshot.length ? "You are browsing extension as:" : "Your identity is undetected" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "mono", children: contextAuthSnapshot.map(([key, value]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      `${key}: ${value}`,
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {})
    ] })) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: contextDataSnapshot.length ? "You are in context of:" : "There is no meaningful context" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "mono", children: contextDataSnapshot.map(([key, value]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      `${key}: ${value}`,
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("br", {})
    ] })) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "row", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: openModal, children: "Open modal" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => closeModal("foo"), children: "Say FOO" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => closeModal("bar"), children: "Say BAR " })
    ] })
  ] });
};
